...
class ClosedLoopServer:
    ...
    def main(self):
        ...
        self.world_transform = to4x4(dataparser_outputs.dataparser_transform).to(self.model.device, dtype=base_dtype)
        self.actor_transform = to4x4(dataparser_outputs.actor_transform).to(self.model.device, dtype=base_dtype)
    ...
    def get_actor_trajectories(self) -> list[TrajectoryDict]:
        ...
        poses_3x4 = self.model.dynamic_actors.get_poses_3x4().to(self.world_transform.dtype)
        ...
        ##############################################
        print("DEBUG actor_transform shape:", self.actor_transform.shape)
        print("DEBUG actor_transform:", self.actor_transform)
        ###############################################
